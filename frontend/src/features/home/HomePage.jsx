	...
	return (
		<div className="space-y-6 md:space-y-8">
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
				...
				<MetricCard
					title="Profit"
					value={financials.profit.label}
					period={financials.profit.period}
					change={financials.profit.change}
					trend={financials.profit.trend}
					icon={TrendingUp}
					details={financials.profit.details}
				/>
				<MetricCard
					title="Loss"
					value={financials.loss.label}
					period={financials.loss.period}
					change={financials.loss.change}
					trend={financials.loss.trend}
					icon={TrendingDown}
					details={financials.loss.details}
				/>
			</div>
					...
					<div className="flex items-start gap-4 mb-6">
						...
						<div className="flex-1">
							...
							<p className="text-gray-600 text-sm md:text-base">
								Unlock $5.2M–$8.7M in annual opportunities with AI-powered
								insights
							</p>
						</div>
					</div>
							...
							{sources.map((source, index) => (
								<div key={index}>
									...
									<a
										...
										target="_blank"
										rel="noopener noreferrer"
										className="text-sm text-ups-teal hover:text-ups-teal-dark flex items-center gap-1 transition-colors"
									>
										{source.url}
